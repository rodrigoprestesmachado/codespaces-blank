...
%\urlstyle{rm}
%
\usepackage{arydshln} % Add this line to use the \hdashline command
...
%
\titlerunning{Analyzing Student Interaction with Chatbots through Metacognition}
% If the paper title is too long for the running head, you can set
% an abbreviated paper title here
%
\author{
Rodrigo Prestes Machado\inst{1}\orcidID{0000-0003-0428-6387} \and
Carlos Alario-Hoyos\inst{2}\orcidID{0000-0002-3082-0814} \and
Patricia Callejo\inst{2}\orcidID{0000-0001-6124-6213} \and
Iria Estévez-Ayres\inst{2}\orcidID{0000-0002-1047-5398} \and
Carlos Delgado Kloos\inst{2}\orcidID{0000-0003-4093-3705}}
%
\authorrunning{Machado, R. P., et al.}
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{Instituto Federal de Educação, Ciência e Tecnologia, Porto Alegre, Brazil \\
\url{http://poa.ifrs.edu.br} \\
\email{rodrigo.prestes@poa.ifrs.edu.br} \and
Universidad Carlos III de Madrid, Leganés, Spain \\
\url{https://www.uc3m.es} \\
\email{\{calario, pcallejo, ayres, cdk\}@it.uc3m.es}
}
%
...
\begin{tabular}{|p{4cm}|p{8cm}|} % Add vertical bars
\hline
...
\centering
\renewcommand{\arraystretch}{1.2} % Increase the spacing between rows
    \begin{tabular}{|p{4cm}|p{4cm}|p{4cm}|} % Add vertical bars
        \hline
