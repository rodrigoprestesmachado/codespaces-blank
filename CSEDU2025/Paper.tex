...
two metacognitive strategies: interleaving and spacing. By analyzing the logs
of student interactions with the chatbot, the methodology involved
classifying and categorizing student prompts into eight distinct types. The
findings reveal that, while most interactions focus on active learning
strategies, students show limited conscious application of study strategies such
as interleaving and spacing. The study highlights the need for more
comprehensive guidance on the strategic use of AI tools to enhance learning
outcomes.
}
