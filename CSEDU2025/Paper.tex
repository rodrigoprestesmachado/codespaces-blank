...
\abstract{This study investigates the interaction patterns of programming
students with a generative AI-powered chatbot (CharlieBot) in the context of a
Java programming course. Specifically, it explores how students utilize the bot,
enhanced with Retrieval-Augmented Generation (RAG), along with two metacognitive
strategies: interleavBaha24Sun24ing and spacing. The methodology analyzed and
classified student conversations, focusing on types of interactions such as
conceptual questions and debugging help. The results indicate that most
interactions are focused on active learning strategies, although the deliberate use
of interleaving and spacing is limited. The study highlights the need for more
guidance on the strategic use of AI tools to improve learning outcomes.}
...
Recent advances in Generative Artificial Intelligence (GenAI) have opened up
