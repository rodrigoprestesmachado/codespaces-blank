...
\title{
  AAnalyzing Student Use of Spacing and Interleaving Strategies in Interactions
...
\begin{table*}[htbp]
  ...
  \begin{center}
    \renewcommand{\arraystretch}{1.1} % Increase the spacing between rows
...
\begin{figure*}[htbp]
  \centering
  \includegraphics[scale=0.42]{img/figure2.png}
